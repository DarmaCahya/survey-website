...
async function seedRealData() {
  ...
  try {
    ...
    // Inline latest assets/threats data (no external JSON dependency)
    /** @type {Array<{id:number,"title-data":string,description:string,threats:Array<{id:number,title:string,description:string,business_processes?:Array<{name:string,explanation?:string}>}>}>} */
    const assetsData = [
      {
        "id": 1,
            ...
            "business_processes": [
              {
                ...
                "explanation": "Gangguan integrasi API ke marketplace atau kurir sehingga pesanan tidak diproses, tertunda, atau status pengiriman tidak akurat."
              },
              {
                "name": "Finance",
                "explanation": "Kebocoran atau manipulasi data transaksi dari payment gateway yang dapat menyebabkan kesalahan pencatatan atau kehilangan dana."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan Barang",
                "explanation": "Kegagalan sinkronisasi data produk, stok, atau pesanan karena layanan pihak ketiga terganggu."
              },
              {
                "name": "Finance",
                "explanation": "Transaksi otomatis yang menggunakan layanan pihak ketiga bisa termanipulasi atau tidak tercatat dengan benar."
              }
            ]
          }
        ]
            ...
            "business_processes": [
              {
                ...
                "explanation": "Akses tidak sah dapat mengubah atau mengosongkan stok produk sehingga data inventaris tidak akurat."
              },
              {
                "name": "Customer Service",
                "explanation": "Pelaku bisa membalas pesan pelanggan dengan informasi palsu atau menipu pelanggan melalui chat toko."
              },
              {
                "name": "Penjualan Barang",
                "explanation": "Perubahan harga, penghapusan produk, atau penarikan saldo yang merugikan pemilik toko."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan Barang",
                "explanation": "Akun toko diambil alih, pelaku dapat melakukan penipuan, mengganti informasi pengiriman, atau menarik dana."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan Barang",
                "explanation": "Serangan massal dapat menyebabkan banyak toko diretas jika pengguna menggunakan kredensial sama di berbagai platform."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan Barang",
                "explanation": "Pemilik akun tertipu menyerahkan akses, mengakibatkan kehilangan kontrol toko dan potensi kerugian finansial."
              },
              {
                "name": "Promosi",
                "explanation": "Penipuan yang menargetkan pemilik akun bisa menonaktifkan atau menyalahgunakan kampanye promosi berbayar."
              }
            ]
          }
        ]
        ...
        "threats": [
          {
            ...
            "business_processes": [
              {
                "name": "Customer Service",
                "explanation": "Malware dapat mencuri percakapan, mengganggu respon ke pelanggan, atau mengambil alih akun komunikasi."
              },
              {
                "name": "Upload data content",
                "explanation": "Perangkat yang terinfeksi dapat kehilangan konten asli atau menyebabkan pengunggahan konten palsu.\n"
              },
              {
                "name": "Promosi",
                "explanation": "Akses akun promosi dapat disalahgunakan untuk memposting iklan palsu atau mengalihkan anggaran iklan."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Upload data content",
                "explanation": "Akun yang diretas dapat kehilangan kontrol atas jadwal posting konten."
              },
              {
                "name": "Promosi",
                "explanation": "Pelaku dapat mengubah pengaturan kampanye iklan atau menayangkan konten yang merusak reputasi."
              }
            ]
          }
        ]
        ...
        "threats": [
          {
            ...
            "business_processes": [
              {
                "name": "Backup data keuangan",
                "explanation": "Cadangan laporan keuangan yang rusak menghambat audit dan proses pelaporan."
              },
              {
                "name": "Customer",
                "explanation": "Cadangan data pelanggan yang tidak lengkap menyebabkan kehilangan histori pesanan dan data kontak."
              },
              {
                "name": "Vendor",
                "explanation": "Ketidaktersediaan cadangan kontrak vendor dapat mengganggu pengadaan dan negosiasi."
              },
              {
                "name": "Report",
                "explanation": "Laporan operasional yang tidak lengkap menghambat analisis kinerja dan pengambilan keputusan."
              }
            ]
          }
        ]
        ...
        "threats": [
          {
            ...
            "business_processes": [
              {
                "name": "Finance",
                "explanation": "Enkripsi atau pencurian file keuangan menghentikan proses pembayaran, rekonsiliasi, dan pelaporan."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Finance",
                "explanation": "Transfer tidak sah atau penggantian rekening dapat menyebabkan kehilangan dana dan masalah rekonsiliasi."
              }
            ]
          }
        ]
        ...
        "threats": [
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan Barang",
                "explanation": "Penyebaran data pelanggan dapat mempengaruhi keamanan pengiriman dan personalisasi penjualan."
              },
              {
                "name": "Customer Service",
                "explanation": "Informasi pelanggan yang bocor mengurangi kepercayaan pelanggan dan memperberat beban layanan."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan Barang",
                "explanation": "Pelanggan tertipu memberikan detail pembayaran atau OTP sehingga pesanan bermasalah."
              },
              {
                "name": "Customer Service",
                "explanation": "Layanan pelanggan harus menangani klaim dan komplain akibat penipuan tersebut."
              }
            ]
          }
        ]
            ...
            "business_processes": [
              {
                ...
                "explanation": "Perubahan rekening atau instruksi pembayaran palsu dapat menyebabkan pengiriman dana ke pihak tidak berwenang."
              }
            ]
          }
        ]
        ...
        "threats": [
          {
            ...
            "business_processes": [
              {
                "name": "Contract Pembelian dengan vendor",
                "explanation": "Pengungkapan syarat kontrak atau harga yang seharusnya privat bisa merugikan posisi negosiasi."
              },
              {
                "name": "Contract dengan karyawan",
                "explanation": "Bocornya data kontrak karyawan dapat menimbulkan masalah hukum dan pelanggaran privasi."
              },
              {
                "name": "Legalitas PT",
                "explanation": "Dokumen legal yang bocor dapat mengekspos struktur kepemilikan, izin usaha, atau informasi sensitif korporat."
              }
            ]
          }
        ]
            ...
            "business_processes": [
              {
                ...
                "explanation": "Penyerang dapat mengganggu mesin, cetak struk, atau akses data transaksi yang menyebabkan gangguan layanan."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Produksi/Operasional",
                "explanation": "Intersepsi komunikasi internal dapat menyebabkan perintah palsu atau kebocoran konfigurasi."
              },
              {
                "name": "Penjualan",
                "explanation": "Data transaksi yang disadap (mis. nomor kartu atau kredensial) dapat menimbulkan penipuan pembayaran."
              }
            ]
          }
        ]
        ...
        "threats": [
          {
            ...
            "business_processes": [
              {
                "name": "Finance",
                "explanation": "Kompromi akun bank dapat menyebabkan transfer tidak sah, kehilangan dana, dan gangguan arus kas."
              }
            ]
          }
        ]
        ...
        "threats": [
          {
            ...
            "business_processes": [
              {
                "name": "Customer Service",
                "explanation": "Akun yang diretas dapat digunakan untuk memberikan informasi palsu, menunda jawaban, atau menipu pelanggan."
              },
              {
                "name": "Promosi",
                "explanation": "Pelaku dapat mengirim promosi palsu atau menyesatkan pelanggan melalui kanal resmi."
              },
              {
                "name": "Penjualan Barang",
                "explanation": "Pemalsuan bukti pembayaran atau instruksi pengiriman yang menyebabkan kerugian pesanan."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Customer Service",
                "explanation": "Pegawai ditipu menyerahkan informasi sensitif pelanggan atau akses sistem."
              },
              {
                "name": "Promosi",
                "explanation": "Kampanye atau pesan promosi disalahgunakan untuk menipu audiens."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Customer Service",
                "explanation": "Percakapan pelanggan yang bocor dapat mengungkap data sensitif dan memperburuk kepercayaan."
              },
              {
                "name": "Promosi",
                "explanation": "Data audiens yang bocor dapat disalahgunakan untuk spam atau penipuan."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Customer Service",
                "explanation": "Akun CS yang diretas menyebabkan gangguan layanan dan klaim pelanggan."
              },
              {
                "name": "Finance",
                "explanation": "Bukti pembayaran yang dipalsukan atau instruksi transfer yang salah dapat merusak proses pembayaran."
              }
            ]
          }
        ]
        ...
        "threats": [
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan",
                "explanation": "Perangkat kasir yang terkunci atau datanya terenkripsi menghentikan transaksi di toko."
              },
              {
                "name": "Pembelian",
                "explanation": "Dokumen PO atau komunikasi pembelian yang hilang mengganggu proses pengadaan."
              },
              {
                "name": "Produksi",
                "explanation": "Perangkat yang mengontrol produksi atau inventaris terganggu menyebabkan penundaan produksi."
              },
              {
                "name": "Finance",
                "explanation": "Akses ke file keuangan yang dicuri atau terenkripsi menghambat rekonsiliasi dan pelaporan."
              }
            ]
          }
        ]
        ...
        "threats": [
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan",
                "explanation": "Data pelanggan atau transaksi yang bocor dapat menurunkan kepercayaan dan mempengaruhi penjualan."
              },
              {
                "name": "Pembelian",
                "explanation": "Data vendor atau harga yang bocor merusak negosiasi dan pengadaan."
              },
              {
                "name": "Produksi",
                "explanation": "Rencana produksi atau BOM yang bocor bisa mengganggu operasi pabrik."
              },
              {
                "name": "Finance",
                "explanation": "Laporan finansial yang bocor dapat mempengaruhi keputusan investor atau kepatuhan."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan",
                "explanation": "Website atau portal penjualan tidak dapat diakses sehingga transaksi online terhenti."
              },
              {
                "name": "Customer Service",
                "explanation": "CS tidak dapat mengakses sistem pelanggan sehingga layanan terdampak."
              },
              {
                "name": "Operasional",
                "explanation": "Gangguan pada sistem internal menghentikan proses operasional penting."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan",
                "explanation": "Pengubahan data pesanan atau harga oleh akun yang mendapatkan hak lebih tinggi."
              },
              {
                "name": "Pembelian",
                "explanation": "Permintaan pembelian atau penerimaan barang dapat dimanipulasi."
              },
              {
                "name": "Produksi",
                "explanation": "Perubahan jadwal atau parameter produksi tanpa otorisasi menyebabkan cacat produk."
              },
              {
                "name": "Finance",
                "explanation": "Akses berlebih ke modul keuangan memungkinkan manipulasi laporan."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan",
                "explanation": "Gangguan layanan pihak ketiga memengaruhi ketersediaan fitur penjualan seperti integrasi checkout."
              },
              {
                "name": "Pembelian",
                "explanation": "Gangguan pada sistem supplier menghambat proses pemesanan dan penerimaan barang."
              },
              {
                "name": "Produksi",
                "explanation": "Keterlambatan pasokan komponen mengganggu lini produksi."
              },
              {
                "name": "Finance",
                "explanation": "Kesalahan atau kebocoran data keuangan pihak ketiga memengaruhi rekonsiliasi."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan",
                "explanation": "Data pesanan atau pelanggan dapat diubah atau dihapus."
              },
              {
                "name": "Pembelian",
                "explanation": "Permintaan pembelian atau data vendor bisa dimanipulasi."
              },
              {
                "name": "Produksi",
                "explanation": "Data produksi yang diubah menyebabkan kesalahan operasional."
              },
              {
                "name": "Finance",
                "explanation": "Akses tidak sah dapat mengarah pada penggelapan atau manipulasi laporan keuangan."
              }
            ]
          }
        ]
        ...
        "threats": [
          {
            ...
            "business_processes": [
              {
                "name": "Inventory Management",
                "explanation": "Injeksi yang memanipulasi tampilan stok atau data produk menyebabkan ketidaksesuaian inventaris."
              },
              {
                "name": "Customer Service",
                "explanation": "Informasi salah pada website meningkatkan pertanyaan pelanggan dan komplain."
              },
              {
                "name": "Penjualan barang",
                "explanation": "Halaman produk yang diserang mengurangi konversi dan kepercayaan pembeli."
              },
              {
                "name": "Promosi",
                "explanation": "Link promosi dapat diarahkan ke pihak ketiga berbahaya sehingga merusak kampanye pemasaran."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan barang",
                "explanation": "Website down menyebabkan hilangnya kesempatan transaksi dan pendapatan."
              },
              {
                "name": "Customer Service",
                "explanation": "CS tidak bisa mengakses data pesanan untuk membantu pelanggan."
              },
              {
                "name": "Operasional",
                "explanation": "Gangguan ini dapat memicu keterlambatan pemenuhan pesanan."
              }
            ]
          },
          {
            ...
            "business_processes": [
              {
                "name": "Penjualan barang",
                "explanation": "Checkout yang termanipulasi memungkinkan pesanan diproses tanpa pembayaran valid."
              },
              {
                "name": "Finance",
                "explanation": "Manipulasi pembayaran menyebabkan kehilangan pendapatan dan masalah rekonsiliasi."
              }
            ]
          }
        ]
    ...
    // Cache of business process name to id to avoid duplicates
    const bpNameToId = new Map();
      ...
      for (const threatData of assetData.threats) {
        ...
        for (const bp of bps) {
          ...
          if (!processId) {
            ...
            const existing = await prisma.businessProcess.findFirst({ where: { name: processName } });
            if (existing) {
    ...
    // Summary for business processes
