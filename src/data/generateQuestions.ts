...
export const generateQuestions = (topic: string): Question[] => [
    ...
    {
        id: `${topic}_pemahaman_tidak_mengerti`,
    ...
    {
        "id": `${topic}_penjelasan_tidak_dipahami`,
