  ...
  return (
    <section className="px-6 py-14 max-w-5xl mx-auto">
      ...
      <div className="space-y-2 text-gray-800">
        <h1 className="text-3xl font-semibold text-purple-700">Akun Media Sosial</h1>
        <p className="text-justify leading-relaxed">
          Akun di platform media sosial seperti Instagram, TikTok, Facebook, dan YouTube digunakan
          untuk berinteraksi dengan followers, mengunggah konten, menjalankan kampanye promosi,
          serta mengelola komentar dan pesan. Akun ini biasanya memuat kredensial
          (username/password), akses admin/manager (termasuk pihak ketiga seperti social management
          tools), serta data interaksi pengguna (komentar, DM, analytics). Karena akun media sosial
          terkait reputasi merek dan komunikasi dengan pelanggan, kompromi akun dapat menyebabkan
          penyebaran konten palsu, hilangnya follower, kerugian reputasi, atau pencurian data
          interaksi pelanggan.
        </p>
      </div>
