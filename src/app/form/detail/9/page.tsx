...
export default function DetailForm() {
  ...
  const threats = [
    {
      ...
      title: "Phishing",
      description:
        "Upaya penipuan melalui email, website palsu, atau chat untuk memperoleh data sensitif seperti username, password, atau OTP. Dampaknya meliputi akses tidak sah ke rekening bank, pencurian dana, dan potensi kerugian finansial bagi perusahaan.",
    },
  ];
  ...
  // 🔹 Filter pertanyaan dinamis seperti versi sebelumnya
    ...
    <section className="px-6 py-14 max-w-5xl mx-auto">
      ...
      <div className="space-y-2 text-gray-800">
        ...
        <p className="text-justify leading-relaxed">
          Akun bank mencakup username, password, token, dan kredensial lain yang digunakan untuk mengakses data rekening perusahaan. Data ini digunakan untuk keperluan transaksi keuangan, pembayaran vendor, dan pengelolaan kas perusahaan.
          Karena memuat informasi finansial sensitif, aset ini termasuk kategori data kritikal. Kebocoran atau penyalahgunaan akun bank dapat menimbulkan kerugian finansial langsung, gangguan operasional, dan risiko hukum.
        </p>
      </div>
