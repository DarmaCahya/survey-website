...
export default function Form() {
    return (
        <section className="px-6 py-14 lg:py-20 xl:py-28 max-w-5xl mx-auto">
            {/* Header Section */}
                        ...
                        >
                            <div className="flex flex-col gap-2">
                                <div className="flex flex-col justify-center items-center">
                                    <h3 className="font-semibold text-lg md:text-xl text-purple-600">{item.title}</h3>
                                    {/* Status badge */}
                                    <div className="">
                                        <span
